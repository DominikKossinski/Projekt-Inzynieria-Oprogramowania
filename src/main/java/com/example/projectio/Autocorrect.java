...
import java.util.Vector;
    ...
    /**
     * Klasa Autocorrect pozwalająca na poprawianie ortografii w tekstach
     *
     * @author Mariusz
     */
...
public class Autocorrect {
    ...
    public static void init(String path){
        Autocorrect.dictionary =  new Vector<Vector<String>>();
        ...
        Autocorrect.letters = new String[][]{{"ó", "u"}, {"o", "ó"}, {"rz", "ż"}, {"ch", "h"}, {"l", "ł"}, {"a", "ą"}, {"e","ę"}};
        Autocorrect.alphabet = "abcćdeęfghijklłmnoópqrsśtuwyzźż";
    }
    ...
    private String checkPossible(){
        ...
        /**
         * Metoda klasy Autocorrect pozwalająca na poprawienie całego zdania
         *
         * @param sentence - (String) zdanie do poprawienia
    ...
    public String correctSentence(String sentence){
        correctedSentence = "";
        wordsArray = new String[1];
        if(sentence.contains(" ")) wordsArray = sentence.toLowerCase().split(" ");
        else wordsArray[0] = sentence.toLowerCase();
